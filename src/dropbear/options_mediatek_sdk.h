...
#define DROPBEAR_DEFAULT_CLI_AUTHKEY "/etc/ssh/id_dropbear"
...
/* TP-LINK has real credentials in a separate file, use this define
   to make our dropbear compatible with theirs. It will look for  
   the '-A <file>' option and will use admin password from the 
   password:<hash> line in the specified file. */
/*#define USE_DROPBEARPWD*/
